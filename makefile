...
linux:
	g++ $(CFLAGS) $(SRC) -DLINUX_COMPILE -o $(LNK) -isystem"/usr/include/SDL2" -isystem"/usr/include/x86_64-linux-gnu/ruby-2.1.0" -isystem"/usr/include/ruby-2.1.0" -lm -lruby-2.1 -lSDL2 -lGL -lGLEW -lassimp -licuuc -licuio
